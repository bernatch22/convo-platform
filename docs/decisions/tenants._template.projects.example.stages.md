# `tenants._template.projects.example.stages`

The reasoning that used to live in the docstrings of `tenants/_template/projects/example/stages/__init__.py`; the code keeps one line per symbol.
