# `tenants.tienda-sur.projects.pedidos.evals.scoring`

The reasoning that used to live in the docstrings of `tenants/tienda-sur/projects/pedidos/evals/scoring.py`; the code keeps one line per symbol.
